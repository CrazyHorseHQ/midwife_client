    ...
    submit: function () {
      ...
      var new_service_user = this.store.createRecord('service_user', {
        ...
        personal_fields: {
          ...
          home_address_line1: self.get('home_address_line1'),
          home_address_line2: self.get('home_address_line2'),
          home_type: self.get('home_type'),
          home_county: self.get('home_county'),
          home_city: self.get('home_city'),
          ...
          next_of_kin_name: self.get('next_of_kin_name'),
